...
**세 시점이 나온다** (`<run>/inspect/<시점>/segcmp_frame_XXXX.png`):

| 시점 | 마스크 | pose | 무엇이 남나 |
|---|---|---|---|
| `arms/` | 1개(기준) | **RH1·RH2·RP3** | 마스크가 같으니 **«pose 알고리즘 차이» 만** |
...
- ④ 좌하단 **mm 눈금자**로 «몇 mm 어긋났나» 를 읽는다(물체 평면 기준).
