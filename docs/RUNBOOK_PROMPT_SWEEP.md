...
>    이제는 «후보 거리» 가 아니라 **«flange 경로가 필요한 구간» 의 증거용**이다.
>    🔴 ~~**배포 대역은 0.56~0.66m**~~ → **«28cm 배제» 만 확정이고 대역은 미정**이다(§44-18c·§44-24c).
>    35~50cm·66cm 초과를 안 쟀고, sim 씬 고정 사다리에서는 **오선택을 빼면 KPI 가 전 거리 ~100%** 라
>    **«거리 최적점» 자체가 분할의 성질**이었다. **다음 촬영은 35·45·56·66·80cm 처럼 벌려서** 찍는다.
